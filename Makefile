...
opencam2d: main.c hersheyfont.c setup.c dxf.c dxf.h font.c font.h texture.c
	clang -ggdb -Wall -O3 -o opencam2d main.c hersheyfont.c setup.c dxf.c font.c texture.c ${LIBS} ${INCLUDES} ${CFLAGS}

gprof:
	gcc -pg -Wall -O3 -o opencam2d main.c hersheyfont.c setup.c dxf.c font.c texture.c ${LIBS} ${INCLUDES} ${CFLAGS}
	echo "./opencam2d"
