...
//	{"Text-Font",	"Milling",	"-mf",	T_SELECT,	0,	0.0,	0.0,	"",	0.0,	1.0,	1.0,		"", 1, 1, "font for mtext", 0, 0, 0},
	...
	{"Use Taps",	"Holding-Tabs",	"-hu",	T_BOOL	,	1,	0.0,	0.0,	"",	0.0,	1.0,	1.0,		"", 1, 1, "using holding-tabs", 0, 0, 0},
	...
	{"X-Grid",	"Holding-Tabs","-ht",	T_DOUBLE,	0,	0.0,	45.0,	"",	0.0,	1.0,	100.0,		"", 1, 1, "X-grid of the holding-tabs", 0, 0, 0},
	{"Y-Grid",	"Holding-Tabs","-ht",	T_DOUBLE,	0,	0.0,	45.0,	"",	0.0,	1.0,	100.0,		"", 1, 1, "Y-grid of the holding-tabs", 0, 0, 0},
